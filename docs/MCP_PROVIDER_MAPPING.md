...
> **文档性质：代码审查基线与实施映射资产**  
> **文档位置：`docs/MCP_PROVIDER_MAPPING.md`**  
...
- **工程资产文档**：
  - `docs/MCP_PROVIDER_MAPPING.md`（本文档）
  - `docs/XYDC_CAPABILITY_MAPPING.md`
  - `docs/MCP_PROVIDER_IMPLEMENTATION_REPORT.md`
...
### Q16: 最小侵入式实现路径是什么？
```text
Phase 0: Mapping 审计定界（docs/MCP_PROVIDER_MAPPING.md）
   ↓
...
Phase 2: 通用轻量 MCP Runtime（Client + ConnectionManager + Executor + Discovery）
   ↓
Phase 3: XYDC 真实 Discovery 探测与映射（docs/XYDC_CAPABILITY_MAPPING.md）
   ↓
